...
if salario > 1250:
  print(f"Você recebeu um aumento de 10% seu salario era {salario}, agora é {salario + (salario*0.10)}")
else:
  print(f"Você recebeu um aumento de 15% antes seu salario era {salario}, agora é {salario + (salario*0.15)}")
